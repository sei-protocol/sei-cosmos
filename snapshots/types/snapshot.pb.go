...
// NodeKey represents a key of a node in the DB
type SnapshotNodeKey struct {
	Version int64  `protobuf:"varint,1,opt,name=version,proto3" json:"version,omitempty"`
	Nonce   uint32 `protobuf:"varint,2,opt,name=nonce,proto3" json:"nonce,omitempty"`
}

func (m *SnapshotNodeKey) Reset()         { *m = SnapshotNodeKey{} }
func (m *SnapshotNodeKey) String() string { return proto.CompactTextString(m) }
func (*SnapshotNodeKey) ProtoMessage()    {}
func (*SnapshotNodeKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_dd7a3c9b0a19e1ee, []int{4}
}
func (m *SnapshotNodeKey) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SnapshotNodeKey) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SnapshotNodeKey.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SnapshotNodeKey) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SnapshotNodeKey.Merge(m, src)
}
func (m *SnapshotNodeKey) XXX_Size() int {
	return m.Size()
}
func (m *SnapshotNodeKey) XXX_DiscardUnknown() {
	xxx_messageInfo_SnapshotNodeKey.DiscardUnknown(m)
}

var xxx_messageInfo_SnapshotNodeKey proto.InternalMessageInfo

func (m *SnapshotNodeKey) GetVersion() int64 {
	if m != nil {
		return m.Version
	}
	return 0
...
func (m *SnapshotNodeKey) GetNonce() uint32 {
	if m != nil {
		return m.Nonce
	}
	return 0
...
type SnapshotIAVLItem struct {
	...
	// Inner Node Key with version and nonce
	Innerkey *SnapshotNodeKey `protobuf:"bytes,5,opt,name=innerkey,proto3" json:"innerkey,omitempty"`
}
...
func (m *SnapshotIAVLItem) GetInnerkey() *SnapshotNodeKey {
	if m != nil {
		return m.Innerkey
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*SnapshotNodeKey)(nil), "cosmos.base.snapshots.v1beta1.SnapshotNodeKey")
...
var fileDescriptor_dd7a3c9b0a19e1ee = []byte{
	...
	,
}
...
func (m *SnapshotNodeKey) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SnapshotNodeKey) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SnapshotNodeKey) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.Nonce != 0 {
		i = encodeVarintSnapshot(dAtA, i, uint64(m.Nonce))
		i--
		dAtA[i] = 0x10
	}
	if m.Version != 0 {
...
func (m *SnapshotIAVLItem) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Innerkey != nil {
		{
			size, err := m.Innerkey.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *SnapshotNodeKey) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.Nonce != 0 {
		n += 1 + sovSnapshot(uint64(m.Nonce))
	}
	return n
}
...
func (m *SnapshotNodeKey) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SnapshotNodeKey: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SnapshotNodeKey: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
