...
func (suite *IntegrationTestSuite) TestSendCoinsAndWei() {
	...
	require.NoError(keeper.SendCoinsAndWei(ctx, addr1, addr2, nil, sdk.ZeroInt(), sdk.ZeroInt()))
	...
	require.NoError(keeper.SendCoinsAndWei(ctx, addr1, addr3, nil, sdk.NewInt(50), sdk.ZeroInt()))
	require.Equal(sdk.ZeroInt(), keeper.GetWeiBalance(ctx, addr1))
	...
	require.Error(keeper.SendCoinsAndWei(ctx, addr1, addr2, nil, sdk.ZeroInt(), sdk.NewInt(1_000_000_000_000)))
	// sender gets escrowed one usei, recipient does not get redeemed
	require.NoError(keeper.SendCoinsAndWei(ctx, addr1, addr2, nil, sdk.NewInt(1), sdk.NewInt(1)))
	...
	require.NoError(keeper.SendCoinsAndWei(ctx, addr1, addr3, nil, sdk.NewInt(1), sdk.NewInt(999_999_999_999)))
	require.Equal(sdk.ZeroInt(), keeper.GetWeiBalance(ctx, addr1))
	...
	require.NoError(keeper.SendCoinsAndWei(ctx, addr1, addr3, nil, sdk.NewInt(1), sdk.NewInt(2)))
