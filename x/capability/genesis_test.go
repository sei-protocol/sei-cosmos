...
func (suite *CapabilityTestSuite) TestGenesis() {
	...
	deliverCtx, _ := newApp.BaseApp.NewUncachedContext(false, tmproto.Header{}).WithBlockGasMeter(sdk.NewInfiniteGasMeterWithLogger(newApp.Logger(), "test")).CacheContext()
